...
static NSString *ks = @"Yjg5OTJkMjExMjcxM2E5OGM1ZTYwMzJhMTUyMjI3M2VkNzE4NDhjOHwxMDI7MTAyOzEwMDkxMzE5MTY3OzI7MTQ1MTMxOTE2Ny44OTY5O3lvc3NpLnBhcGlhc2h2aWxpQGthbHR1cmEuY29tOzs7";
...
+ (void)audioFor:(NSDictionary *)object completion:(void (^)(NSURL *, NSError *))completion {
    NSDictionary *getURLObj = nil;
    @synchronized(getURLObj) {
        getURLObj = @{@"service": @"flavorAsset",
                      @"action": @"geturl",
                      @"format": @"1",
                      @"id": object[@"id"],
                      @"ks": ks};
